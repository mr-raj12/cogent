...
import type { Message, ContentBlock, ToolUseBlock, ToolResultBlock, StopReason } from "../types.js";
...
//     // NOTE: Gemini always returns "end_turn" even when tools were called,
//     // so we check assistantBlocks directly instead of relying on stopReason
