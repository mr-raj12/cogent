// Phase 1 test — run: npm run test:provider
// Tests Gemini and Groq providers independently (needs API keys in .env or env vars)

import { createProvider, MODELS } from "../src/providers/index.js";
